...
final class PermalinkAssignedTest extends TestCase {
	public function testItWillSerializeCorrectly() {
		$array = [
			'type' => PermalinkAssigned::class,
			...
			'payload' => ['permalink' => '/thing/slug'],
		];

		$object = new PermalinkAssigned(
			permalink: '/thing/slug',
