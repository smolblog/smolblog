...
/**
 * Trait to proivde string methods for Values that are scalars. Pair with the StringableValue interface.
 */
trait StringableValueKit {
	/**
	 ...
	 * @return static
	 */
	public static function deserialize(mixed $string): static {
